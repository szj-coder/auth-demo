...
public class AntlrDemoParser extends Parser {
    ...
    public static class ScriptContext extends ParserRuleContext {
        public TerminalNode EOF() {
            return getToken(AntlrDemoParser.EOF, 0);
        }
    ...
    public final ScriptContext script() throws RecognitionException {
        final ScriptContext _localctx = new ScriptContext(_ctx, getState());
    ...
    public final StatementsContext statements() throws RecognitionException {
        final StatementsContext _localctx = new StatementsContext(_ctx, getState());
    ...
    public static class StatementBlockContext extends ParserRuleContext {
        public TerminalNode OPENCURLY() {
            return getToken(AntlrDemoParser.OPENCURLY, 0);
        }
        ...
        public TerminalNode CLOSECURLY() {
            return getToken(AntlrDemoParser.CLOSECURLY, 0);
        }
    ...
    public final StatementBlockContext statementBlock() throws RecognitionException {
        final StatementBlockContext _localctx = new StatementBlockContext(_ctx, getState());
    ...
    public static class MultOrDivContext extends ExprContext {
        ...
        public TerminalNode MULT() {
            return getToken(AntlrDemoParser.MULT, 0);
        }

        public TerminalNode DIV() {
            return getToken(AntlrDemoParser.DIV, 0);
        }
    ...
    public static class LogicalOperatorContext extends ExprContext {
        ...
        public TerminalNode NOT() {
            return getToken(AntlrDemoParser.NOT, 0);
        }

        public LogicalOperatorContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OperatorExprContext extends ExprContext {
        ...
        public TerminalNode MINUS() {
            return getToken(AntlrDemoParser.MINUS, 0);
        }

        public TerminalNode GREATER() {
            return getToken(AntlrDemoParser.GREATER, 0);
        }

        public TerminalNode GREATEREQUAL() {
            return getToken(AntlrDemoParser.GREATEREQUAL, 0);
        }

        public TerminalNode LESS() {
            return getToken(AntlrDemoParser.LESS, 0);
        }

        public TerminalNode LESSEQUAL() {
            return getToken(AntlrDemoParser.LESSEQUAL, 0);
        }

        public TerminalNode AND() {
            return getToken(AntlrDemoParser.AND, 0);
        }

        public TerminalNode OR() {
            return getToken(AntlrDemoParser.OR, 0);
        }

        public OperatorExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class PlusOrMinusContext extends ExprContext {
        ...
        public TerminalNode PLUS() {
            return getToken(AntlrDemoParser.PLUS, 0);
        }
        ...
        public PlusOrMinusContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class TernaryOperatorContext extends ExprContext {
        ...
        public TernaryOperatorContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class FactorExprContext extends ExprContext {
        ...
        public FactorExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ParenExprContext extends ExprContext {
        public TerminalNode LPAREN() {
            return getToken(AntlrDemoParser.LPAREN, 0);
        }
        ...
        public TerminalNode RPAREN() {
            return getToken(AntlrDemoParser.RPAREN, 0);
        }
    ...
    public static class ObjFactoryContext extends FactorContext {
        public TerminalNode BOOLEAN() {
            return getToken(AntlrDemoParser.BOOLEAN, 0);
        }

        public TerminalNode VARIABLE() {
            return getToken(AntlrDemoParser.VARIABLE, 0);
        }
        ...
        public ObjFactoryContext(FactorContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NumFactoryContext extends NumberContext {
        public TerminalNode INTEGER() {
            return getToken(AntlrDemoParser.INTEGER, 0);
        }

        public TerminalNode DOUBLE() {
            return getToken(AntlrDemoParser.DOUBLE, 0);
        }

        public NumFactoryContext(NumberContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IfContext extends IfExpressionContext {
        public TerminalNode IF() {
            return getToken(AntlrDemoParser.IF, 0);
        }
        ...
        public IfContext(IfExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IfElseContext extends IfExpressionContext {
        ...
        public TerminalNode ELSE() {
            return getToken(AntlrDemoParser.ELSE, 0);
        }

        public IfElseContext(IfExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IfElseIfContext extends IfExpressionContext {
        ...
        public IfElseIfContext(IfExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public final VarExpressionContext varExpression() throws RecognitionException {
        final VarExpressionContext _localctx = new VarExpressionContext(_ctx, getState());
